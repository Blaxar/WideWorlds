...
function makeReversedOctahedron() {
  ...
  bufferGeometry.setAttribute('position', new THREE.BufferAttribute(new Float32Array(positions), 3));
	bufferGeometry.setAttribute('color', new THREE.BufferAttribute(new Float32Array(colors), 3));
  ...
  return new THREE.Mesh(bufferGeometry, new THREE.MeshBasicMaterial({vertexColors: true}));
}

export {makeReversedOctahedron};
