...
class Prop {
   ...
   * @param {integer} x - X coordinate of the prop (in centimeters).
   * @param {integer} y - Y coordinate of the prop (in centimeters).
   * @param {integer} z - Z coordinate of the prop (in centimeters).
   * @param {integer} ya - Yaw of the prop (in decidegrees).
   * @param {integer} pi - Pitch of the prop (in decidegrees).
   * @param {integer} ro - Roll of the prop (in decidegrees).
